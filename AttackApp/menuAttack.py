...
analizador.add_argument('operacion', choices=['TrafficFlow', 'Scan', 'Servidor', 'SSHAttack', 'Monitorizar'],  help="Permite escoger entre una de las 4 opciones descritas anteriormente")
...
group.add_argument('-d', action="store_true", dest='dispositivo', help="Uno o más dispositivos, se requiere "
                                                                        "de indicar mediante su ip correspondiente o su nic(sw, wr, r1, r2, r3)")
#Opción de Scan:
'''
if(argumento.operacion == "Scan" or argumento.operacion == "SSHAttack"):
    group2 = analizador.add_argument_group('-ip', action="store_true", dest="ip")
    group2.add_argument('--h', action='store', nargs='+', type=str, dest='host', help="Se debe dar una o varias IPs para escanear")
    group2.add_argument('--o', action="store", nargs='+', type=str, dest='origen', help="Uno o más hosts origen, se requiere "
                                                                            "de indicar mediante su ip correspondiente o su nic Ejemplo: (RP_R1_1)")
    group2.add_argument('--m', action='store', nargs='+', type=str, dest='mask', help="Se debe dar el prefijo de cada una de las Ips introducidas" )

    group.add_argument(group2)
##############
else: 
'''
